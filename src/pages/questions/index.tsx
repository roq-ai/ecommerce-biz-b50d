...
export function QuestionListPage(props: QuestionListPageProps) {
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('solution', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'solution',
          header: 'Solution',
          accessorKey: 'solution',
          cell: ({ row: { original: record } }: any) => (
            <Link as={NextLink} onClick={(e) => e.stopPropagation()} href={`/solutions/view/${record.solution?.id}`}>
              {record.solution?.name}
            </Link>
          ),
        }
      : null,
